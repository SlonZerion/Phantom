...
function e(e){return e&&e.__esModule?e.default:e}function t(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var n=("undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{}).parcelRequire1d24;n.register("Cx7PX",(function(r,l){var i;i=r.exports,Object.defineProperty(i,"__esModule",{value:!0,configurable:!0}),t(r.exports,"ExplorePageContent",(function(){return y})),t(r.exports,"default",(function(){return N}));var a=n("54qyi"),o=n("egSKH"),s=n("lDSNw"),c=n("bjaYq"),d=n("lz7nT"),u=n("5Z2YQ"),p=n("cZIbv"),m=n("kn91D"),f=n("fnNJD"),x=n("cHds5"),g=n("dk3Xb"),h=n("1tudC"),E=n("lAgRD"),b=n("gMNJN"),w=n("iacGS"),k=n("d1qx3");function y(){var t;b.hooks.useExploreLoadAllQueries();const n=(0,d.useLocation)(),{t:r}=(0,c.useTranslation)(),{data:l}=b.hooks.useShouldShowQuests({platform:"extension",appVersion:(0,k.getManifestVersion)()}),{error:i,refetch:p}=b.hooks.useQuests({platform:"extension",appVersion:(0,k.getManifestVersion)()}),{setActiveSection:m,activeSection:y}=(0,a.useExplore)();(0,s.useEffect)((()=>{var e;"quests"===(null===(e=n.state)||void 0===e?void 0:e.tab)&&l&&m("quests")}),[null===(t=n.state)||void 0===t?void 0:t.tab,l,i,m]);const{error:N,refetch:P}=b.hooks.useLearn(),{error:T,refetch:A}=b.hooks.useExploreTokens(),{error:R,refetch:M}=b.hooks.useExploreSites(),{error:$,refetch:j}=b.hooks.useExploreCollections(),{error:F,refetch:Z}=b.hooks.useExploreRecommendedTokens(),{error:z,refetch:_}=b.hooks.useExploreRecommendedSites(),{error:B,refetch:G}=b.hooks.useExploreRecommendedCollections(),q=i&&N&&T&&R&&$&&F&&z&&B,O=(0,s.useCallback)((()=>{l&&p(),A(),M(),j(),Z(),_(),G(),P()}),[p,A,M,j,Z,_,G,P,l]),[Q,X]=e(s).useState(""),H=(0,u.useDebouncedState)(Q,250),U=e(o)((e=>{e&&w.exploreAnalytics.onExploreSearchedByUser({searchTerm:e})}),1e3),V=!!H;return(0,s.useEffect)((()=>{U(H)}),[H,U]),q?e(s).createElement(S,null,e(s).createElement(f.ExplorePageError,{title:r("exploreErrorTitle"),buttonText:r("exploreErrorButtonText"),description:r("exploreErrorDescription"),refetch:O})):e(s).createElement(v,null,e(s).createElement(x.ExploreSearchHeader,{value:Q,onChange:X}),e(s).createElement(C,{hide:V},e(s).createElement(E.ExploreTabsTitles,null)),e(s).createElement(I,{hide:V},e(s).createElement(h.ExploreTabs,null),"tokens"===y&&e(s).createElement(L,null,e(s).createElement(D,null,r("exploreTokensLegalDisclaimer")))),e(s).createElement(I,{hide:!V},e(s).createElement(g.ExploreSearchResults,{query:H})))}const v=p.default.div`
  position: absolute;
  display: flex;
...
`,D=(0,p.default)(m.Text)`
  ...
  line-height: 16px;
  text-align: left;
`;var N=()=>e(s).createElement(a.ExploreProvider,{appVersion:(0,k.getManifestVersion)(),platform:"extension",initialSection:"sites"},e(s).createElement(y,null))})),n.register("fnNJD",(function(r,l){t(r.exports,"ExplorePageError",(function(){return h}));var i=n("lDSNw"),a=n("cZIbv"),o=n("44I6u"),s=n("aanFI"),c=n("6l2nq"),d=n("kn91D");const u=(0,a.default)(o.Column).attrs({align:"center"})``,p=a.default.div`
  width: 48px;
  height: 48px;
  position: relative;
  margin-bottom: 15px;
